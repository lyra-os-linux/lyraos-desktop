...
window.LyraI18n=(()=>{
  const catalogs={
    'en-US':{
      ...
      storageDiscoveryFailed:'Could not inspect the available disks.',firmwareUnknown:'Could not determine the boot firmware. Inspect the installation environment before continuing.',biosBoot:'BIOS · 2 MiB boot partition (Secure Boot requires UEFI)',planBoot:'Boot mode',planFailed:'Could not calculate a safe installation plan.',
    ...
    'pt-BR':{
      ...
      espReuse:'ESP existente reaproveitada em {path}',espCreate:'UEFI · nova ESP de {size}; boot pelo disco se NVRAM indisponível',swapNone:'Sem swap nem ZRAM',swapZram:'ZRAM (memória comprimida)',swapDisk:'Swap em disco · {size}',planEfi:'Partição EFI',planFilesystem:'Sistema de arquivos',planMemory:'Memória virtual',planBtrfs:'Btrfs · {count} subvolumes',planErased:'Dados que serão apagados nesta instalação:',calculatingPlan:'Calculando o plano de instalação…',summarySwapDisk:'Swap em disco (8 GiB)',confirmErase:'Entendo que os dados de {target} serão apagados permanentemente.',
      ...
      storageDiscoveryFailed:'Não foi possível verificar os discos disponíveis.',firmwareUnknown:'Não foi possível identificar o firmware de boot. Verifique o ambiente de instalação antes de continuar.',biosBoot:'BIOS · partição de boot de 2 MiB (Secure Boot exige UEFI)',planBoot:'Modo de boot',planFailed:'Não foi possível calcular um plano de instalação seguro.',
    ...
    'es-ES':{
      ...
      storageDiscoveryFailed:'No se pudieron consultar los discos disponibles.',firmwareUnknown:'No se pudo identificar el firmware de arranque. Revisa el entorno de instalación antes de continuar.',biosBoot:'BIOS · partición de arranque de 2 MiB (Secure Boot requiere UEFI)',planBoot:'Modo de arranque',planFailed:'No se pudo calcular un plan de instalación seguro.',
