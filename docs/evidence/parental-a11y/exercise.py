...
generated=a11y_probes+[settings_probe,raw_profile,settings_dir/'user',settings_dir/'elf-probe',bus_probe,window_test,launcher,dropin,profile,database,debuglog,keydir/'00-policy',keydir/'locks/00-policy']
...
backup = fixture_recovery.snapshot(
    [worker,helper,native,ctl,shell,entry,application,xwayland,xclient,xkbcomp,mutter,x11ready,frames,xsettings,dconf_service,a11y_settings,a11y_hook]+atspi+[P('/etc/gdm/custom.conf')],
