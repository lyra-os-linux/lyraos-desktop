...
generated=[bus_probe,window_test,launcher,dropin,profile,database,debuglog,keydir/'00-policy',keydir/'locks/00-policy']
...
subprocess.run(['rpm','-V','mutter','gnome-settings-daemon','accountsservice'],check=True)
...
backup = fixture_recovery.snapshot(
    [worker,helper,native,ctl,shell,entry,application,xwayland,xclient,xkbcomp,mutter,x11ready,frames,xsettings]+atspi+[P('/etc/gdm/custom.conf')],
