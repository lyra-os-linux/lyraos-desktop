# ADR 0016: adiar compatibilidade Android e Windows para o ciclo 28.02
...
A Alpha 7 migrou o Lyra OS Desktop 27.02 para openSUSE Leap 16.1. A primeira
...
O mantenedor definiu que este trabalho volta a ser discutido no ciclo 28.02.
Vinculá-lo à Alpha 8 apenas deslocaria silenciosamente uma funcionalidade ampla
para o mesmo ciclo 27.02, próximo do congelamento funcional da Beta 1.

## Decisão

Todo suporte de produto a aplicativos Android e Windows é retirado do ciclo
Desktop 27.02. Isso inclui:
...
- promessa de compatibilidade ou matriz de aplicativos no 27.02.

As issues permanecem no backlog do ciclo **28.02**. Elas não recebem `alpha-8`,
pois a Alpha 8 ainda pertence ao 27.02 e deve concentrar-se no fechamento de
...
## Reabertura no ciclo 28.02

Antes de implementar, o mantenedor deve:

1. definir o calendário e os estágios internos do ciclo 28.02;
...
- a ISO 27.02 não ganha permissões, serviços ou downloads de runtime adicionais;
- #14, #15, #16, #17, #18 e #19 ficam abertas e classificadas como 28.02;
- o adiamento não transfere automaticamente as funcionalidades para Alpha 8,
  Beta 1 ou Beta 2;
- qualquer exceção no 27.02 exige nova decisão explícita, análise de risco,
