...
MINIMUMS = {
    'vega-gtk': '5.1.45', 'sheliak': '2.0.3', 'lyra-welcome': '0.4.1',
    'lyra-os-theme': '1.9.4', 'lyra-os-icons': '1.9.4',
    'lyra-nautilus-branding': '1.9.4', 'libreoffice-branding-Lyra': '1.0.0',
    'linuxtoys': '6.9', 'lyra-upgrade': '0.2.5', 'beam': '1.0.1',
    'sulafat': '1.0.4', 'vegad': '5.1.32',
    'lyra-installer': '0.1.0',
    'lyra-downloads': '0.1.3',
    'lyra-downloads-firefox-integration': '0.1.3',
    'lyra-firefox-ext': '0.1.3',
    'lyra-firefox-theme': '0.1.0', 'lyra-vms': '0.1.0',
}
